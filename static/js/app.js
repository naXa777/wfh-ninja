  ...
  render: function() {
    return (
        <div className="site-wrapper">
          ...
          <Quotes />
          <SubmitForm />
          <p className="ack">Original <a href="http://getbootstrap.com/examples/cover/" target="_blank">Cover</a>
            template for <a href="http://getbootstrap.com" target="_blank">Bootstrap</a> created by <a
            ...
            <div className="inner">
              <nav>
                <ul className="nav mastfoot-nav">
                  <li><a href="#">
                    <div onClick={this.scrollDown}>Submit</div>
                  </a></li>
                  <li><a href="https://github.com/christinang89/wfh-ninja" target="_blank">Docs</a></li>
                  <li><a
                      href="https://medium.com/@christinang89/wfh-ninja-a-quotable-site-for-all-your-excuses-9b57dd7fad4f"
